        ...
        <section className="grid content-center items-center md:justify-center gap-5 h-screen p-6">
            ...
            <div>
                <article className="text-center">
                    <p className="font-bold text-sm text-white antialiased">Não possui cadastro? <Link className="underline text-bright-turquoise-300 hover:text-bright-turquoise-500" href="/cadastro">Cadastre-se</Link></p>
                </article>
            </div>
        </section>
    </>
